...
md temp
@echo OpenSilver.Simulator 2.0.0-private-%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
nuget.exe pack nuspec\OpenSilver.Simulator.nuspec -OutputDirectory "output/OpenSilver" -BasePath "%batDirectory%" -Properties "PackageVersion=2.0.0-private-%PackageVersion%;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
