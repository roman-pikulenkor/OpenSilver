...
set /p PackageVersion="%ESC%[92mOpenSilver version:%ESC%[0m 2.0.0-private-"
...
md temp
@echo OpenSilver 2.0.0-private-%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver;PackageVersion=2.0.0-private-%PackageVersion%;Configuration=SL;Target=OpenSilver;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver.UWPCompatible;PackageVersion=2.0.0-private-%PackageVersion%;Configuration=UWP;Target=OpenSilver.UwpCompatible;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
