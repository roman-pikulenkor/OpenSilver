...
#endif
{
    ...
    public class DataTemplateKey
    {
        ...
        /// initializing the <see cref="DataTemplateKey.DataType"/> property.
        /// </summary>
        ...
        /// the <see cref="DataTemplateKey.DataType"/> property to the specified value.
        /// </summary>
        /// <param name="dataType">
        ...
        /// <summary>
        /// Returns the hash code of the <see cref="DataTemplateKey.DataType"/> property
        /// value.
        /// </summary>
        /// <returns>
        /// The hash code of the <see cref="DataTemplateKey.DataType"/> property value,
        /// or 0 if <see cref="DataTemplateKey.DataType"/> is null.
        /// </returns>
        ...
        internal static Exception ValidateDataType(object dataType, string argName)
        {
            ...
            {
                result = new ArgumentException(string.Format("'{0}' is not a valid type for DataTemplate.DataType; it must be Type.", dataType.GetType().Name), argName);
            }
